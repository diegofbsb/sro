...
public class ConferenciaLeocBean extends MonitorManagedBean{
    ...
    private static boolean nomeUniMostra = false;
    ...
    public static void setDrMostra(boolean drMostra) {
    	ConferenciaLeocBean.drMostra = drMostra;
    }
    ...
    public static void setNomeUniMostra(boolean nomeUniMostra) {
    	ConferenciaLeocBean.nomeUniMostra = nomeUniMostra;
    }
