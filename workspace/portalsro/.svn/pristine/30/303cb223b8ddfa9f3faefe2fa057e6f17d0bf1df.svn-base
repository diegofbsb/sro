...
<html>
    <f:view>
        ...
        <head>
            ...
            <title><h:outputText value="#{config.detalhePendenciaBaixaTitle}" /></title>
        </head>
        <body>
            <div class="content" >
                <br/>
                ...
                <h:outputText id="textNomeUnidade" value="#{detalhePendencia.nome} (#{detalhePendencia.codigo})" />
                <jsp:include flush="false" page="/helpHeader.html" />
                <div class="tableContainer">
                    <div class="tablecaption">
                        <p><h:outputText value="#{config.detalhePendenciaBaixaTitle}" /></p>
                    </div>
                    
                    <h:dataTable value="#{detalhePendencia.transmissoes}" var="item" rowClasses="even,odd" styleClass="blue" id="myTable"  >
                    ...
                    <div class="tablecaption">
                        <p><h:outputText value="#{config.footerDetalhe}"/><h:outputText value="#{detalhePendencia.numObjetos}" /></p>
                    </div>
                    <script  type="text/javascript">
	var table3Filters = {
                on_change:true,
