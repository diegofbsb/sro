    ...
    <f:loadBundle basename="resources.pages" var="config" />
        ...
        <body>
            ...
            <div class="content" >
                ...
                <br/>
                <h2><h:outputText value="#{config.os60conferenciaLoec}" /></h2>
                <h:form id="formControl2" onsubmit="return valida();">
                    <h:panelGrid columns="4" >
                    
                        <h:outputLabel value="#{config.dr}" for="selectDR" />
                        <h:selectOneMenu value="#{conferenciaLeocBean.dr}" id="selectDR" >
                        ...
                        <h:selectOneMenu value="#{conferenciaLeocBean.tipoUnidadeInt}" id="textTipoUnidadeInt" >
                        ...
                        <h:panelGroup>
                        <h:inputText value="#{conferenciaLeocBean.uniName}" id="textUniName" title="#{config.uniNameHint}" />
                        </h:panelGroup>
                        ...
                        <h:panelGroup>
                            <h:inputText value="#{conferenciaLeocBean.startDate}" id="startDate" required="true"  >
                        ...
                        <h:panelGroup>
                            <h:inputText value="#{conferenciaLeocBean.endDate}" id="endDate" required="true"  >
                                <f:convertDateTime pattern="dd/MM/yyyy" />
                            </h:inputText>
                        ...
                        <h:commandButton value="#{config.os060ok}" styleClass="button" action="#{conferenciaLeocBean.pesquisar}" />
                        <f:verbatim>
                            &nbsp;
                        </f:verbatim>
                        <f:verbatim>
