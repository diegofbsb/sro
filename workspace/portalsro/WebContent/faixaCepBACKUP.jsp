				...
				<h:form id="formFaixaCep">
					<h:panelGrid columns="2" id="panelFaixaCep">
						...
						<h:panelGroup>
							...
							<br /><br />
							<h:commandButton id="btnIncluir" action="#{faixaCep.abrirInclusao()}" value="#{config.incluir}" styleClass="button" />
							&nbsp;&nbsp;
							<h:commandButton id="btnExcluir" action="#{faixaCep.abrirExclusao()}" value="#{config.excluir}" styleClass="button" />
						</h:panelGroup>
					</h:panelGrid>
				</h:form>
